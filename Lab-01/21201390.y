...
%token IF ELSE FOR WHILE DO BREAK INT FLOAT CHAR VOID DOUBLE RETURN SWITCH CASE DEFAULT CONTINUE GOTO PRINTF ADDOP MULOP INCOP RELOP LOGICOP DECOP ASSIGNOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON COMMA ID CONST_INT CONST_FLOAT
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("21201390.txt", ios::trunc);
